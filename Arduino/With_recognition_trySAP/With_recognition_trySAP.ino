...
const char* ssid = "Elfat";
const char* password = "1234";

// the names of ssid and password below are for connecting to another wifi
// but for the Soft access point there is a need to be const and pointer
//String ssid = "Elfat";
...
void rzoCheckForFace() {
  ...
  // this code has to be removed because it returns string  return "not connnected";
